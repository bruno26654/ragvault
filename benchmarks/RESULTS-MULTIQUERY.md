...
|---|---|---|---|---|---|---|---|
| single | 0.167 | 0.493 | 0.174 | 0.758 | 196 | 3.53 | 3.75 |
| multi-manual | 0.875 | 0.951 | 0.340 | 0.889 | 200 | 4.38 | 4.69 |
| multi-decomposed | 0.333 | 0.618 | 0.215 | 0.585 | 197 | 4.36 | 4.96 |

## Reading

- multi-query (committed subqueries) changes full-recall by **+0.708** and recall by **+0.458** vs a single query.
- latency cost: **1.24x** the single-query p50 for 3 queries — the subqueries run in one batched native call (`search_many`, GIL released), not sequentially.
