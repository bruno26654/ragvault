...
def verify(payload: dict) -> dict:
    ...
    return _json(complete(
        ...
        "3. Todo veredito precisa nomear seu lastro, e o RagVault confere: "
        "inclua 'quote' com as palavras exatas que o sustentam, copiadas "
        "literalmente — da fonte citada para 'supported', da pergunta para "
        "'question_fact', de qualquer um dos dois para 'inference' e "
        "'contradicted'. Citação inventada reprova a afirmação.\n"
...
answer = kb.ask_multi(
    ...
    resolve_versions=True,         # versão atual vence a substituída
